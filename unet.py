...
class Unet(object):
    _defaults = {
        "model_path": 'weights/unet_test.pth',
    ...
    def generate(self):
        ...
        if self.num_classes <= 21:
            self.colors = [(0, 0, 0), (255, 0, 0), (0, 255, 0), (128, 128, 0), (0, 0, 128), (128, 0, 128),
                           (0, 128, 128),
    ...
    def detect_image(self, image, filename):
        ...
        #   将新图片和原图片混合
        # ------------------------------------------------#
        path = 'img/PNG/' + filename + '.png'
        image = Image.open(path).convert('RGB')
        saturation = ImageEnhance.Color(old_img)
        old_img = saturation.enhance(4)
        contrast = ImageEnhance.Contrast(old_img)
        old_img = contrast.enhance(1.5)
...
if __name__ == '__main__':
    img = Image.open("img/PNG/000805-20190727@090508-L2-S.png")
    # contest()
